<?php
    ...
    <div class="product">
        <img src="image/golden.png" alt="SE03" class="product1-img">
    ...
    <div class="productcard">
        <div class="card">
            <h2>Rhyno SE03  Specifications</h2>
            <div class="specs">
                <div><span class="label">Warranty on Electronics:</span><span class="value">1 year</span></div>
                <div><span class="label">Battery:</span><span class="value">2.7 Kwh/h<span></div>
                ...
                <div><span class="label">Max Range (@Full Speed):</span><span class="value"> </span></div>
                ...
                <div><span class="label">Battery Features:</span><span class="value">LFP with 1500 cycles Active Balancing Waterproof (IP67)
</span></div>
            </div>
        </div>
    </div>
