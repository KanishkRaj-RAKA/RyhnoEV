...
<body>
    <div class="product">
        <img src="image/black.png" alt="SE03" id="product1-img" class="product1-img">
    ...
    <div class="productcard">
        <div class="card">
            ...
            <div class="specs">
                ...
                <div><span class="label">Battery:</span><span class="value">1.8 Kwh</span></div>
                <div><span class="label">Motor:</span><span class="value">1500W</span></div>
                <div><span class="label">Charging Time:</span><span class="value">3 hours (12A)</span></div>
                <div><span class="label">Battery Warranty:</span><span class="value">3 Years</span></div>
                <div><span class="label">Max Speed:</span><span class="value">50 km/h</span></div>
                <div><span class="label">Max Range (@Full Speed):</span><span class="value">70 km</span></div>
                <div><span class="label">Max Range (@45km/h):</span><span class="value">90 km</span></div>
                <div><span class="label">Max Range (@30km/h):</span><span class="value">100 km</span></div>
                <div><span class="label">Other Key Benefits:</span><span class="value">Fire-safe battery, Range prediction, Comfortable ride, Stable and safe</span></div>
                <div><span class="label">Battery Features:</span><span class="value">LFP with 1500 cycles, Active Balancing, Waterproof (IP67)</span></div>
            </div>
        </div>
    </div>
